...
fit_and_eval_lm <- function(target, pred_cols) {
  ...
  fwrite(out_df, file = paste0("Meteo_csv/", target, "_lm_predictions.csv"))
...
fwrite(pct_df, file = "Meteo_csv/C_lm_predicted_percentages.csv")
...
fwrite(df_C1, file = "Meteo_csv/df_C1_features.csv")
fwrite(df_C2, file = "Meteo_csv/df_C2_features.csv")
fwrite(df_C3, file = "Meteo_csv/df_C3_features.csv")
...
lm_preds <- data.frame(index = test_idx,
                       ...
                       pred_pct1 = pred_pct1, pred_pct2 = pred_pct2, pred_pct3 = pred_pct3,
                       act_pct1 = act_pct1, act_pct2 = act_pct2, act_pct3 = act_pct3)
fwrite(lm_preds, file = "Meteo_csv/C_lm_predictions_combined.csv")
